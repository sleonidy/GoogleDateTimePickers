 ...
 *
 * Adaptations made by Rainer Burgstaller
 */
...
public class TimePickerDialogSupport extends DialogFragment implements OnValueSelectedListener, OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(mEnableClearButton ? R.layout.time_picker_dialog_clear
                : R.layout.time_picker_dialog, null);
